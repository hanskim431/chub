...
|담당자| 주요 작업|
|----------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **유윤지**  | - 화면 구조를 정의한 기초 프로토타입 제작<br>- 실시간 차트 퍼블리싱 및 api 연동<br>- 마이페이지 탭 퍼블리싱 및 api 연동<br> - 검색 바, 모달 구현 및 대회 배너 제작<br>- TDD 방식을 활용한 프론트엔드 테스트 코드 작성<br>- 기능 오류 수정 및 UI/UX 개선                                                                                                                                                                                                                                                                                                                                                                                                                                    |
