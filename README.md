...
| 담당자      | 주요 작업                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
|----------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **우윤지**  | - 화면 구조를 정의한 기초 프로토타입 제작<br>- 실시간 차트 퍼블리싱 및 api 연동<br>- 마이페이지 탭 퍼블리싱 및 api 연동<br> - 검색 바, 모달 구현 및 대회 배너 제작<br>- TDD 방식을 활용한 프론트엔드 테스트 코드 작성<br>- 기능 오류 수정 및 UI/UX 개선                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| **김현수**  | - [실시간 통신 프로토콜 사전 부하 테스트](https://lab.ssafy.com/s13-fintech-finance-sub1/S13P21A508/-/wikis/%F0%9F%9A%80-%EC%8B%9C%EA%B3%84%EC%97%B4-%EB%8D%B0%EC%9D%B4%ED%84%B0-%EC%A1%B0%ED%9A%8C-%EC%84%B1%EB%8A%A5-%EC%B5%9C%EC%A0%81%ED%99%94)<br>- 실시간 체결 정보 조회 로직 구현<br>- SSE 연결 관리 시스템 설계 및 구현<br>- 스냅샷 기반 종목 순위 정렬 시스템 설계 및 구현<br>- [GZIP을 통한 네트워크 트래픽 개선 (6 MB/s -> 940 kB/s)](https://lab.ssafy.com/s13-fintech-finance-sub1/S13P21A508/-/wikis/gzip%EC%9D%84-%ED%86%B5%ED%95%9C-%EB%84%A4%ED%8A%B8%EC%9B%8C%ED%81%AC-%EC%98%A4%EB%B2%84%ED%97%A4%EB%93%9C-%EC%95%95%EC%B6%95)<br>- 백엔드 계층별 단위 테스트 코드 작성(TDD) |
